  ...
  [(keyword (str "div.container"
   ...
   [:ul {:style {:overflow "hidden"}}
    ...
    [:li"開発・運営費の寄付を募集中です。PayPal経由で「Meriken's Tripcode Generator」を購入するか、Bitcoinで直接送金をお願いします: " [:br]
     [:a#Jiyz.sellfy-buy-button.in-new-page {:style {:vertical-align :middle} :href "https://sellfy.com/p/Jiyz/"} "Buy Now"] [:span.script-wrapper [:script {:src "https://sellfy.com/js/api_buttons.js"}]] " "
